...
<section class="shopping-cart">
   ...
   <form action="" method="POST" class="box">
      ...
      <a href="view_page.php?pid=<?= $fetch_cart['pid']; ?>" class="">
      <img src="uploaded_img/<?= $fetch_cart['image']; ?>" alt="" width="306" height="255">
      ...
      <div class="flex-btn">
         <input type="number" min="1" max="<?= $fetch_products['in_stock']; ?>" value="<?= $fetch_cart['quantity']; ?>" class="qty" name="p_qty">
   ...
   <div class="cart-total">
      ...
      <a href="cart.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>">Clear</a>
