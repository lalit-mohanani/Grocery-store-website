...
<section class="wishlist">
   ...
   <form action="" method="POST" class="box">
      ...
      <a href="view_page.php?pid=<?= $fetch_wishlist['pid']; ?>" class="">
      <img src="uploaded_img/<?= $fetch_wishlist['image']; ?>" alt="" width="306" height="255">
      <div class="name"><?= $fetch_wishlist['name']; ?></div>
      <div class="price">₹<?= $fetch_wishlist['price']; ?>/-</div>
      <div class="in_stock"><span><?= $fetch_products['in_stock']; ?></span></div>
      </a>
      <input type="number" min="1" max="<?= $fetch_products['in_stock']; ?>" value="1" class="qty" name="p_qty">
