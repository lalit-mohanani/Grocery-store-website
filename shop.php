...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    <a href="category.php?category=apple">Apple</a>
    <a href="category.php?category=grapes">Grapes</a>
    <!-- <a href="category.php?category=orange">Orange</a> -->
  </div>
</div>
<div class="dropdown">
  <button class="dropbtn">Vegitables</button>
  <div class="dropdown-content">
    <a href="category.php?category=tomato">Tomato</a>
    <a href="category.php?category=potato">Potato</a>
    <a href="category.php?category=onion">Onion</a>
  </div>
</div>
<div class="dropdown">
  <button class="dropbtn">Fish</button>
  <div class="dropdown-content">
    <a href="category.php?category=salmon">Salmon</a>
    <a href="category.php?category=catla">Catla</a>
  </div>
</div>
<div class="dropdown">
  <button class="dropbtn">Meat</button>
  <div class="dropdown-content">
    <a href="category.php?category=beef">Beef</a>
    <a href="category.php?category=chicken">Chicken</a>
    <!-- <a href="category.php?category=mutton">Mutton</a> -->
  </div>
</div>
...
<section class="products">
   ...
   <form action="" class="box" method="POST">
      ...
      <input type="number" min="0" max="<?= $fetch_products['in_stock']; ?>" value="0" name="p_qty" class="qty">
