...
$mail->SMTPAuth = true;
$mail->Username = '167757143fad02';
$mail->Password = '0f1962cabbd99c';
$mail->SMTPSecure = 'tls';
$mail->Port = 25;
$mail->setFrom('lalitmohanani23@gmail.com');
...
if(isset($_POST['order'])){
   ...
   if($cart_total == 0){
      ...
      $mail->Subject = "Your order is on its way! We hope you are as excited as we are.";
      $mail->Body = "Order placed successfully!";
      $mail->send();
